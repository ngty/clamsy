...
Ruby wrapper for generating a single pdf for multiple contexts from an odt template.
  ...
  clamsy = clumsy + shellish
            ...
            |            ps2pdf & pdf2ps, etc.
            |
            |-- setup isn't straight forward, need to instead a couple of packages
                (depending on ur platform) & even manual setting up of cups printer
                is needed
...
1. Archlinux
   ...
   * Setting up the cups-pdf virtual printer by following instructions on:
